...
<section className='w-full h-auto flex justify-center mt-4'>
    <div className='w-[60%] h-auto p-5 bg-green-100 shadow-2xl rounded xsm:w-[85%]'>
       ...
       <div className=' text-center flex-wrap my-2 font-medium'>Thanks for shopping with Waste2Wealth</div>
       ...
       <div className=' text-center flex-wrap my-2'>You will receive an order confirmation email with details of your order</div>
        <div className='bg-green-500 hover:bg-green-600 rounded p-2 w-fit mx-auto mt-3 cursor-pointer'><Link href="/product"><a className='text-white font-semibold'>Continue shopping</a></Link></div>   
    </div>
</section>
    )
}
